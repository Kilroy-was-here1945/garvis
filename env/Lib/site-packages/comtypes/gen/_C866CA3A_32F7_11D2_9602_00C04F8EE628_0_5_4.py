...
__all__ = [
    ...
    'SPWORDPRONOUNCEABLE', 'DISPID_SRCPause', 'DISPID_SRIsShared',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SRGCmdSetRuleIdState', 'SREBookmark',
    'SREPropertyStringChange', 'SpeechRecoEvents', 'SVP_18',
    'ISpRecoGrammar', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SVAudioOutputStream', 'LONG_PTR', 'DISPID_SVPriority',
    'DISPID_SLWLangId', 'SAFT48kHz16BitMono', 'eLEXTYPE_PRIVATE7',
    'DISPID_SRGDictationUnload', 'SDTLexicalForm',
    'SAFT22kHz16BitMono', 'DISPID_SPIRule', 'SPVISEMES',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SGRName',
    'SAFT48kHz16BitStereo', 'DISPIDSPTSI', 'SPAO_NONE',
    'DISPID_SpeechAudioStatus', 'DISPID_SPPs_NewEnum',
    'SRSInactiveWithPurge', 'DISPID_SRGetRecognizers',
    'SVSFParseMask', 'SP_VISEME_10', 'DISPID_SGRClear',
    'SPEI_SR_RETAINEDAUDIO', 'ISpResourceManager',
    'DISPID_SRCSetAdaptationData', 'DISPID_SVStatus',
    'ISpStreamFormatConverter', 'DISPID_SPIEngineId',
    'ISpeechPhoneConverter', 'SSSPTRelativeToStart',
    'DISPID_SMSSetData', 'DISPID_SRCEventInterests',
    'eLEXTYPE_PRIVATE16', 'DISPID_SRGetPropertyString',
    'SAFT11kHz16BitMono', 'SPLEXICONTYPE', 'SREPrivate',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPWT_LEXICAL',
    'SPSFunction', 'SPEI_PHONEME', 'SGRSTTDictation',
    'DISPID_SRGCommit', 'SDTAll', 'DISPID_SVGetAudioOutputs',
    'SECLowConfidence', 'DISPID_SpeechWaveFormatEx', 'ISpEventSink',
    'SRESoundStart', 'STCInprocHandler', 'SpeechTokenValueCLSID',
    'DISPID_SLPSymbolic', 'DISPID_SLPType', 'DISPID_SRRTTickCount',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SAFTGSM610_8kHzMono',
    'DISPID_SVSPhonemeId', 'SPSHORTCUTTYPE',
    'DISPID_SPEAudioSizeTime', 'ISpObjectTokenCategory',
    'ISpPhoneticAlphabetConverter', 'SRTStandard',
    'DISPID_SASetState', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SAFTCCITT_uLaw_11kHzMono', 'SRTReSent', 'SECFEmulateResult',
    'ISpShortcut', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    ...
    'DISPID_SRCEPropertyStringChange', 'SP_VISEME_2', 'SVP_21',
    'STCAll', 'SP_VISEME_7', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SPEDisplayText', 'DISPID_SVEViseme', 'SPAS_PAUSE',
    'DISPID_SPEAudioStreamOffset', 'SINone', 'SPEI_RESERVED3',
    'DISPID_SVSpeakCompleteEvent', 'SLTApp', 'ISpRecoGrammar2',
    'DISPID_SVSyncronousSpeakTimeout', 'SPSModifier', 'SPSHT_OTHER',
    'DISPID_SGRId', 'DISPID_SpeechVoiceEvent', 'SFTSREngine',
    'DISPID_SLWWord', 'SpeechTokenShellFolder', 'SAFTADPCM_44kHzMono',
    'SP_VISEME_12', 'DISPID_SRGState', 'SAFTADPCM_44kHzStereo',
    'SGDSInactive', 'SPEI_RESERVED6', 'eLEXTYPE_PRIVATE14',
    'ISpGrammarBuilder', 'DISPID_SVSLastStreamNumberQueued',
    'SPEI_UNDEFINED', 'SPDKL_LocalMachine', 'SAFT24kHz16BitStereo',
    'SPEI_PROPERTY_STRING_CHANGE', 'SASRun',
    'DISPID_SPEAudioSizeBytes', 'SAFTCCITT_ALaw_11kHzMono', 'SVP_9',
    'DISPID_SPPConfidence', 'SWTDeleted', 'WAVEFORMATEX',
    'SpeechTokenKeyFiles', 'SAFTDefault',
    'ISpeechTextSelectionInformation', 'DISPID_SPARecoResult',
    '__MIDL_IWinTypes_0009', 'SDA_Two_Trailing_Spaces',
    'SPPS_RESERVED3', 'SVEEndInputStream', 'SPSERIALIZEDRESULT',
    'SPRST_INACTIVE', 'DISPID_SOTGetAttribute', 'ISpPhoneConverter',
    'SPEI_SR_PRIVATE', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SPRuleParent', 'SREInterference',
    'ISpeechPhraseAlternates', 'SpeechAudioVolume',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SOTSetId',
    'DISPID_SRState', 'SDTRule', 'SpeechCategoryPhoneConverters',
    'DISPID_SPEs_NewEnum', 'DISPID_SMSAMMHandle', 'SVP_6',
    'SITooSlow', 'SPCATEGORYTYPE', 'SAFTExtendedAudioFormat',
    'SPLOADOPTIONS', 'DISPID_SVRate', 'SDTAudio', 'SPSNoun',
    'ISpAudio', 'SPSMF_SAPI_PROPERTIES', 'SPPS_LMA',
    ...
    'DISPID_SGRInitialState', 'DISPID_SBSRead',
    'DISPID_SREmulateRecognition', 'SPAO_RETAIN_AUDIO', 'SPRS_ACTIVE',
    'SGDSActiveUserDelimited', 'eLEXTYPE_VENDORLEXICON',
    'SPPHRASERULE', 'STCInprocServer', 'SPEI_HYPOTHESIS',
    'SRAORetainAudio', 'DISPID_SVEventInterests',
    'DISPID_SRCCreateGrammar', 'DISPID_SpeechAudio',
    'DISPID_SVAlertBoundary', 'SVP_17', 'DISPID_SGRAddResource',
    'ISpVoice', 'SSFMOpenForRead', 'DISPID_SPAPhraseInfo',
    'ISpeechRecognizer', 'DISPID_SDKOpenKey', 'DISPID_SCSBaseStream',
    'DISPID_SPRText', 'DISPID_SpeechRecoResult', 'SPSMF_UPS',
    'DISPID_SpeechObjectToken', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SDKGetStringValue', 'DISPID_SRRGetXMLErrorInfo',
    'SPWT_PRONUNCIATION', 'ISpeechRecoResult2', 'SSFMCreateForWrite',
    'SRSActive', 'DISPID_SOTGetStorageFileName', 'SPAR_High',
    'SpSharedRecoContext', 'eLEXTYPE_PRIVATE2', 'SGSExclusive',
    'DISPID_SPEDisplayAttributes', 'DISPID_SPIGetText',
    'SpInprocRecognizer', 'SVSFPersistXML', 'SVF_Stressed',
    'DISPID_SDKDeleteValue', 'ISpDataKey', 'SVP_19', 'SpCustomStream',
    'DISPID_SRSSupportedLanguages', 'SAFT32kHz16BitStereo',
    'DISPID_SGRSTText', 'SGRSTTTextBuffer', 'DISPID_SPEsCount',
    'SDTDisplayText', 'SPBO_AHEAD',
    ...
    'SP_VISEME_11', 'SPPS_Noun', 'SRAImport', 'SITooLoud',
    ...
    'DISPID_SWFEExtraData', 'STSF_FlagCreate', 'DISPID_SPIStartTime',
    'ISpeechGrammarRules', 'SVEStartInputStream',
    'DISPID_SpeechLexicon', 'SpeechStreamFileMode', 'DISPID_SOTId',
    'SLODynamic', 'DISPID_SRRTimes', 'SPWORDPRONUNCIATION',
    'SVSFIsFilename', 'SPGS_DISABLED', 'SAFT8kHz16BitStereo',
    'SAFT12kHz8BitMono', 'ISpSerializeState', 'SAFT44kHz16BitStereo',
    'DISPID_SPRsCount', 'DISPID_SMSADeviceId',
    'SpeechCategoryRecognizers', 'SpeechEngineConfidence',
    'DISPID_SOTsItem', 'SLTUser', 'DISPID_SpeechGrammarRule', 'SVP_7',
    'ISpMMSysAudio', 'DISPID_SRCBookmark', 'SpObjectTokenCategory',
    'SPEVENT', 'eLEXTYPE_PRIVATE5', 'SpStreamFormatConverter',
    'DISPID_SPIEnginePrivateData', 'DISPID_SRCEPhraseStart',
    'SpeechEngineProperties', 'tagSTATSTG', 'SPEI_VOICE_CHANGE',
    'DISPID_SVSpeakStream', 'ISpNotifySink', 'DISPID_SPRs_NewEnum',
    '_ISpeechVoiceEvents', 'SPSTREAMFORMATTYPE', 'ISpStream',
    'DISPID_SRCESoundStart', 'SDA_One_Trailing_Space',
    'SAFT48kHz8BitStereo', 'SGDSActive', 'SPCT_SLEEP',
    'DISPID_SPRDisplayAttributes', 'ISpeechRecoResultTimes',
    'eLEXTYPE_RESERVED6', 'SSSPTRelativeToCurrentPosition',
    'ISpPhraseAlt', 'DISPID_SPRuleFirstElement', 'SP_VISEME_17',
    'SVSFIsXML', 'DISPID_SRProfile', 'SpSharedRecognizer',
    'SRAExport', 'SAFT22kHz16BitStereo', 'DISPID_SRCEBookmark',
    'DISPID_SpeechVoiceStatus', 'ISpeechObjectTokenCategory',
    'DISPID_SVSLastResult', 'SRERecoOtherContext', 'SPEI_RESERVED1',
    'DISPID_SVGetVoices', 'SVP_1', 'SpeechGrammarWordType',
    'SGRSTTWord', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SRSetPropertyNumber', 'SVF_None', 'eLEXTYPE_RESERVED8',
    'SpeechTokenKeyAttributes', 'SPXRO_Alternates_SML',
    'DISPID_SBSWrite', 'DISPID_SRGDictationSetState',
    'DISPID_SAVolume', 'SPRST_NUM_STATES', 'DISPID_SRRSpeakAudio',
    'DISPID_SVVolume', 'SpeechInterference', 'DISPID_SGRsDynamic',
    'SGRSTTWildcard', 'SRARoot', 'SAFTCCITT_uLaw_22kHzMono',
    'SPEI_REQUEST_UI', 'SpeechRuleAttributes', 'ISpeechLexicon',
    'DISPID_SOTCId', 'STSF_AppData', 'SGRSTTRule', 'DISPID_SPPName',
    'ISpeechVoice', 'ISpeechPhraseInfo', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SLGetGenerationChange', 'SAFTADPCM_22kHzMono',
    'ISpeechMMSysAudio', 'DISPID_SBSFormat', 'DISPID_SPRuleName',
    'SpeechRecognitionType', 'SRESoundEnd', 'SVSFNLPMask',
    'DISPID_SPERequiredConfidence', 'DISPID_SpeechRecoContext',
    'DISPID_SGRsItem', 'SPRECOGNIZERSTATUS', 'DISPID_SRCERequestUI',
    'DISPID_SpeechPhraseInfo', 'SPPS_Modifier',
    'DISPID_SRGCmdLoadFromFile', 'SpNullPhoneConverter',
    'SAFT44kHz8BitMono', 'SREFalseRecognition', 'eLEXTYPE_PRIVATE4',
    'SpeechLexiconType', 'DISPID_SPPParent', 'SRTAutopause',
    'DISPID_SRCState', 'SPBO_NONE', 'SRATopLevel', 'SPPS_Unknown',
    'ISpeechPhraseRules', 'SPEI_MIN_SR', 'eLEXTYPE_RESERVED9',
    'SPAS_STOP', 'SPSHORTCUTPAIRLIST', 'ISpLexicon',
    'SpeechAllElements', 'ISpeechMemoryStream',
    'DISPID_SPIAudioSizeTime', 'DISPID_SPIGrammarId', 'SPRS_INACTIVE',
    'DISPID_SRCRequestedUIType', 'SAFT24kHz8BitMono', 'DISPID_SVSkip',
    'SpeechAudioFormatGUIDWave', 'DISPID_SDKGetBinaryValue',
    'DISPID_SGRSAddWordTransition', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SpeechPhraseElement', 'SVP_16', 'Speech_Default_Weight',
    'eLEXTYPE_MORPHOLOGY', 'ISpeechCustomStream', 'DISPID_SPEsItem',
    'SpAudioFormat', 'eLEXTYPE_APP', 'SPVPRIORITY',
    'DISPID_SOTMatchesAttributes', 'SPEI_END_SR_STREAM',
    'DISPID_SPRules_NewEnum', 'DISPID_SVSInputWordPosition', 'SVP_8',
    'DISPID_SRCEEnginePrivate', 'SWPKnownWordPronounceable',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SRRSaveToMemory',
    'IInternetSecurityMgrSite', 'SSTTTextBuffer', 'SINoise',
    'DISPID_SRRecognizer', 'SAFT11kHz8BitStereo', 'DISPID_SGRSRule',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SPRuleId',
    'STSF_LocalAppData', 'DISPID_SDKDeleteKey',
    'DISPID_SLGetPronunciations', 'SAFT8kHz8BitStereo',
    ...
    'DISPIDSPTSI_SelectionLength', 'ISpeechRecoGrammar', 'SPWORDTYPE',
    'SPVPRI_OVER', 'DISPID_SRIsUISupported', 'tagSPPROPERTYINFO',
    'DISPID_SPPValue', 'SPPS_Function', 'SVEAllEvents', 'SVEPrivate',
    ...
    'SPBO_TIME_UNITS', 'SPPHRASEREPLACEMENT', 'SPSEMANTICFORMAT',
    'SPAUDIOBUFFERINFO', 'SPRST_INACTIVE_WITH_PURGE',
    'SPEI_START_SR_STREAM', 'SPSUnknown', 'ISpStreamFormat',
    'eWORDTYPE_ADDED', 'ISpeechAudioFormat', 'SPPHRASEPROPERTY',
    'eLEXTYPE_USER_SHORTCUT', 'SP_VISEME_1', 'DISPID_SDKGetlongValue',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPCT_DICTATION',
    'SpeechTokenIdUserLexicon',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRCRetainedAudioFormat', 'SpNotifyTranslator',
    'SAFT8kHz8BitMono', 'DISPID_SVEStreamEnd', 'SVSFParseSapi',
    'SAFTCCITT_ALaw_44kHzMono', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SPAs_NewEnum', 'SPDATAKEYLOCATION', 'SPSERIALIZEDPHRASE',
    'ISpObjectWithToken', 'SP_VISEME_19', 'SVP_4',
    'ISpNotifyTranslator', 'SpeechLoadOption',
    'DISPID_SRGetPropertyNumber', 'SPLO_STATIC',
    'DISPID_SPRuleEngineConfidence', 'SFTInput', 'SVSFVoiceMask',
    'SRTExtendableParse', 'SPINTERFERENCE_NONE',
    'ISpPhoneticAlphabetSelection', 'DISPID_SABIEventBias',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPPS_RESERVED1',
    'eLEXTYPE_PRIVATE17', 'DISPID_SRGCmdLoadFromMemory',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SWFEChannels',
    'SVP_13', 'SAFTADPCM_22kHzStereo', 'SPEI_ADAPTATION',
    'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechVoicePriority', 'SVP_11', 'DISPID_SOTRemove',
    'Speech_Max_Word_Length', 'SREAdaptation', 'SWTAdded',
    'DISPID_SRRTOffsetFromStart', 'SAFT16kHz8BitMono',
    'DISPID_SGRAttributes', 'ISpNotifySource', 'SpStream',
    'ISpeechRecognizerStatus', 'SPEI_TTS_PRIVATE',
    'SAFTGSM610_22kHzMono', 'SpeechPropertyAdaptationOn',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SFSClose',
    'SVEAudioLevel', 'DISPID_SPRuleConfidence', 'eLEXTYPE_PRIVATE11',
    'SPAR_Low', 'DISPID_SRSetPropertyString', 'DISPID_SFSOpen',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SABufferInfo', 'SRCS_Disabled',
    'DISPID_SVVoice', 'ISpeechPhraseAlternate', 'SpeechPartOfSpeech',
    '_SPAUDIOSTATE', 'SDTReplacement', 'SpeechRecoContextState',
    'DISPID_SVEWord', 'SASStop', 'DISPID_SGRsAdd',
    'SWPUnknownWordPronounceable', 'ISpeechGrammarRuleState',
    'SAFT8kHz16BitMono', 'DISPID_SOTCategory', 'DISPID_SGRAddState',
    'ISpeechPhraseElements', 'SPINTERFERENCE_TOOSLOW',
    'SpInProcRecoContext', 'tagSPTEXTSELECTIONINFO',
    'SPSNotOverriden', 'DISPID_SGRsCommitAndSave',
    'SpeechGrammarTagWildcard', 'DISPID_SpeechBaseStream',
    'DISPID_SRStatus', 'ISpeechWaveFormatEx',
    'SpeechDisplayAttributes', 'DISPID_SLAddPronunciationByPhoneIds',
    'Speech_StreamPos_Asap', 'SpTextSelectionInformation',
    'SPWF_SRENGINE', 'DISPID_SLWsCount', 'SAFT32kHz16BitMono',
    'SVEVoiceChange', 'SPEI_RESERVED2', 'SpMMAudioOut',
    'SSTTDictation', 'SP_VISEME_21', 'DISPID_SVEAudioLevel',
    'SITooFast', 'SPCONTEXTSTATE', 'SASClosed', 'DISPID_SRGRules',
    'SpeechDiscardType', 'SpeechRegistryUserRoot', 'DISPID_SGRSTType',
    'SPEI_RECOGNITION', 'SVP_15', 'DISPID_SDKCreateKey',
    'SpeechRecoProfileProperties', 'DISPID_SRGSetWordSequenceData',
    'SPAR_Unknown', 'SDA_No_Trailing_Space', 'SPWAVEFORMATTYPE',
    'SPRST_ACTIVE', 'SPSHT_EMAIL', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SRGCmdLoadFromResource', 'SPGRAMMARSTATE',
    'SECFNoSpecialChars', 'SDKLDefaultLocation',
    'DISPID_SRCERecognizerStateChange', 'SPRECORESULTTIMES',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SpeechFileStream', 'SVP_2',
    'SGLexical', 'SPPARTOFSPEECH', 'DISPID_SRRGetXMLResult',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SVIsUISupported',
    'SGPronounciation', 'SSTTWildcard', 'DISPID_SOTCSetId',
    'DISPID_SPRFirstElement', 'SPBINARYGRAMMAR', 'SPCT_SUB_DICTATION',
    'SpeechWordPronounceable', 'DISPID_SVEStreamStart',
    'eLEXTYPE_RESERVED10', 'ISpRecoContext2',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPADAPTATIONRELEVANCE',
    'DISPID_SVGetAudioInputs', 'SAFT32kHz8BitStereo',
    'SpeechBookmarkOptions', 'DISPID_SVEEnginePrivate',
    'ISpeechLexiconPronunciations', 'ISpeechRecoContext',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SDKLCurrentUser',
    'DISPID_SVDisplayUI', 'SVP_14', 'DISPID_SPPId',
    'DISPID_SpeechRecoResult2',
    'DISPID_SRCERecognitionForOtherContext', 'STSF_CommonAppData',
    'SP_VISEME_3', 'DISPID_SGRSTPropertyValue', 'SP_VISEME_9',
    'DISPID_SRCERecognition', 'IEnumSpObjectTokens',
    'DISPID_SGRSTRule', 'DISPID_SLRemovePronunciation',
    'ISpeechPhraseElement', 'ISpeechAudio', 'SAFT11kHz8BitMono',
    'SPEI_MIN_TTS', 'DISPID_SVSpeak', 'DISPID_SRCEStartStream',
    'SpLexicon', 'DISPID_SLWType', 'ISpeechPhraseRule',
    'DISPID_SVAudioOutput', 'SAFT44kHz8BitStereo',
    'SPDKL_DefaultLocation', 'eWORDTYPE_DELETED', 'SPINTERFERENCE',
    'SREHypothesis', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRGSetTextSelection', 'DISPID_SWFEAvgBytesPerSec',
    'SPWORDLIST', 'SVP_0', 'ISpeechXMLRecoResult', 'DISPID_SVResume',
    'DISPID_SLWPronunciations', 'DISPID_SRCEEndStream',
    'DISPID_SpeechPhraseRule', 'SVEPhoneme', 'SRADynamic',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SRCResume',
    'DISPID_SRRTLength', 'SECFIgnoreCase', 'SPEVENTSOURCEINFO',
    'SAFT16kHz8BitStereo', 'SVEViseme',
    'DISPID_SPIGetDisplayAttributes', 'SPRECOCONTEXTSTATUS',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SAFT11kHz16BitStereo',
    'SPPS_Interjection', 'SPEI_PHRASE_START', 'ISpeechFileStream',
    'eLEXTYPE_PRIVATE19', 'SPFM_NUM_MODES', 'SVSFPurgeBeforeSpeak',
    'SpPhoneticAlphabetConverter', 'SPGRAMMARWORDTYPE',
    'ISpeechAudioBufferInfo', 'SPDKL_CurrentUser',
    'SPSHT_NotOverriden', 'SPAS_CLOSED', 'DISPID_SLPsItem',
    'SP_VISEME_8', 'DISPID_SpeechObjectTokens', 'DISPID_SMSALineId',
    'SAFT12kHz8BitStereo', 'ISpeechLexiconPronunciation',
    'DISPID_SPAStartElementInResult', 'DISPID_SPIElements',
    'ISpRecoCategory', 'SP_VISEME_18', 'DISPID_SpeechGrammarRules',
    'DISPID_SASFreeBufferSpace', 'DISPID_SRGId', 'SRADefaultToActive',
    'SPVPRI_ALERT', 'ISpeechResourceLoader', 'DISPID_SPPsCount',
    'DISPID_SPPsItem', 'SGLexicalNoSpecialChars',
    'DISPID_SOTs_NewEnum', 'SpeechCategoryAudioIn',
    'SAFTCCITT_uLaw_44kHzMono', 'SECNormalConfidence',
    'SAFTGSM610_11kHzMono', 'DISPID_SDKSetBinaryValue',
    'SPEI_WORD_BOUNDARY', 'SVSFUnusedFlags', 'ISpeechLexiconWord',
    'SpPhraseInfoBuilder', 'IEnumString', 'eLEXTYPE_PRIVATE8',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SABufferNotifySize',
    'DISPID_SpeechMemoryStream', 'DISPID_SRCEAdaptation',
    'DISPID_SpeechMMSysAudio', 'SSFMOpenReadWrite', 'SRTSMLTimeout',
    'DISPID_SASNonBlockingIO', 'DISPID_SVSRunningState',
    'eLEXTYPE_PRIVATE15', 'SAFTText', 'DISPID_SOTCDefault',
    'ISpRecoResult', 'SVEWordBoundary', 'DISPID_SPEEngineConfidence',
    'SpShortcut', 'SVSFNLPSpeakPunc', 'SVSFParseAutodetect',
    'SPEI_RECO_STATE_CHANGE', 'SAFT24kHz16BitMono', 'SP_VISEME_16',
    'DISPID_SOTDataKey', 'SDA_Consume_Leading_Spaces',
    'DISPID_SPRuleChildren', 'DISPID_SPEActualConfidence',
    'eLEXTYPE_PRIVATE13', 'SAFT24kHz8BitStereo', 'SREPhraseStart',
    'DISPID_SpeechLexiconProns', 'SpVoice', 'DISPID_SOTCGetDataKey',
    'eLEXTYPE_PRIVATE10', 'DISPID_SVGetProfiles',
    'SPINTERFERENCE_TOOFAST', 'SPFM_OPEN_READWRITE',
    'ISpeechPhraseReplacements', 'DISPID_SAFSetWaveFormatEx',
    'SRAONone', 'SAFTCCITT_uLaw_11kHzStereo', 'ISpRecognizer2',
    'SPFM_CREATE_ALWAYS', 'SAFT32kHz8BitMono',
    'SAFTADPCM_11kHzStereo', 'DISPID_SRRAlternates',
    'DISPID_SGRsCount', 'SPSInterjection', 'DISPID_SWFEBitsPerSample',
    'DISPID_SVEVoiceChange', 'ISpeechGrammarRuleStateTransition',
    'SAFT12kHz16BitMono', 'SpMemoryStream', 'SPXMLRESULTOPTIONS',
    'SGDisplay', 'SPPS_Noncontent', 'SRSEDone', 'ISpRecognizer',
    'SPEI_END_INPUT_STREAM', 'SpeechVoiceSkipTypeSentence',
    'SPAUDIOSTATUS', 'DISPID_SPPNumberOfElements',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SBSSeek', 'SPPHRASE',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SGRSTPropertyId',
    'SASPause', 'SpeechCategoryVoices', 'DISPID_SLWsItem',
    'DISPID_SRCVoicePurgeEvent', 'SpeechWordType',
    'SpeechUserTraining', 'DISPID_SOTsCount',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SpeechPhraseElements',
    'DISPID_SpeechPhraseProperty', 'SVP_5', 'SGRSTTEpsilon',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SpeechDataKey',
    'DISPID_SRAudioInputStream',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SAEventHandle', 'SVPAlert', 'DISPID_SpeechPhraseRules',
    'DISPID_SRRAudio', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SPAsCount', 'SpObjectToken', 'eLEXTYPE_PRIVATE6',
    'SPPS_RESERVED2', 'SpeechRecognizerState',
    'SPINTERFERENCE_TOOQUIET', 'SP_VISEME_15', 'SpeechAddRemoveWord',
    'SPWT_DISPLAY', 'SREStateChange', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SpeechVoice', 'SECFDefault', 'SDTAlternates',
    ...
    'SPCS_DISABLED', 'SSSPTRelativeToEnd', 'DISPID_SpeechLexiconWord',
    'DISPID_SLRemovePronunciationByPhoneIds', 'ISpeechRecoResult',
    'DISPID_SPEPronunciation', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SPACommit', 'SPSHT_Unknown', 'STCRemoteServer',
    'ISpeechPhraseReplacement', 'SGSDisabled', 'ISpEventSource',
    'DISPID_SGRSTsItem', 'SVP_10', 'DISPID_SPCLangId',
    'DISPID_SRGReset', 'DISPID_SGRsCommit', 'SpeechFormatType',
    'SREAllEvents', 'DISPID_SRRTStreamTime', 'SPSSuppressWord',
    'SPFM_OPEN_READONLY', 'SPAR_Medium', 'DISPID_SRGRecoContext',
    'SAFTADPCM_8kHzMono', '_RemotableHandle', 'SPGS_EXCLUSIVE',
    'SGSEnabled', 'DISPID_SOTGetDescription', 'SPSLMA',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SDKSetStringValue',
    'eLEXTYPE_RESERVED7', 'DISPID_SpeechRecognizerStatus',
    'SDTPronunciation', 'SDTProperty', 'SPPS_Verb', 'SVSFlagsAsync',
    'DISPID_SADefaultFormat', 'ISpProperties', 'SpeechMicTraining',
    'DISPID_SRAudioInput', 'SAFTCCITT_uLaw_8kHzMono',
    'SpUnCompressedLexicon', 'SVEBookmark', 'SPAUDIOSTATE', 'SVP_20',
    'DISPID_SPCIdToPhone', 'SpeechAudioFormatGUIDText',
    'SAFT22kHz8BitMono', 'DISPID_SRCESoundEnd',
    'DISPID_SRRPhraseInfo', 'DISPID_SPRulesItem',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPEI_RESERVED5',
    'eLEXTYPE_LETTERTOSOUND', 'SPRULE', 'SPFM_CREATE', 'SPRULESTATE',
    ...
    'DISPID_SLWs_NewEnum', 'SpMMAudioIn', 'SPSVerb',
    'SRSActiveAlways', 'SPEI_MAX_SR', 'DISPID_SPRulesCount',
    'DISPIDSPRG', 'SpMMAudioEnum', 'SpeechVoiceEvents',
    'DISPID_SLPs_NewEnum', 'SVPNormal', 'DISPID_SGRSTransitions',
    'SRSEIsSpeaking', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFTGSM610_44kHzMono',
    'SPXRO_SML', 'DISPID_SRCRetainedAudio', 'DISPID_SGRSTsCount',
    'eLEXTYPE_PRIVATE9', 'SVSFDefault', 'SVF_Emphasis',
    ...
    'DISPID_SVSCurrentStreamNumber', 'SRERequestUI',
    'DISPID_SRCEAudioLevel', 'SAFT48kHz8BitMono',
    'DISPID_SpeechAudioBufferInfo', 'SPSEMANTICERRORINFO',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SPIReplacements', 'SPWF_INPUT', 'SP_VISEME_5',
    'SPFILEMODE', 'DISPID_SVESentenceBoundary', 'DISPID_SLPsCount',
    'SpeechVoiceSpeakFlags', 'ISpeechObjectTokens', 'ISpRecoContext',
    'SpResourceManager', 'SREPropertyNumChange',
    'ISpeechPhraseInfoBuilder', 'SpeechCategoryRecoProfiles',
    'SPPHRASEELEMENT', 'SVSFIsNotXML', 'SpeechAudioProperties',
    'SPEI_START_INPUT_STREAM', 'SpeechDataKeyLocation',
    'DISPID_SRSClsidEngine', 'SPSHORTCUTPAIR', 'DISPID_SASState',
    'ISpeechLexiconWords', 'SpeechCategoryAppLexicons',
    'eLEXTYPE_RESERVED4', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SAFGuid', 'SAFTNonStandardFormat', 'SP_VISEME_14',
    'DISPID_SGRSTPropertyName', 'SPAS_RUN', 'SP_VISEME_20',
    'DISPID_SPIAudioSizeBytes', 'SPINTERFERENCE_NOISE',
    'ISpeechPhraseProperties', 'SpFileStream', 'eLEXTYPE_PRIVATE3',
    'ISpXMLRecoResult', 'DISPID_SABIMinNotification',
    'DISPID_SRSCurrentStreamNumber', 'ISpeechPhraseProperty',
    'DISPID_SGRs_NewEnum', 'DISPID_SPRsItem',
    'DISPID_SPPFirstElement', 'DISPID_SVEPhoneme', 'ISpObjectToken',
    ...
    'eLEXTYPE_PRIVATE1', 'SITooQuiet', 'DISPID_SGRSTs_NewEnum',
    'SPCT_SUB_COMMAND', 'SPGS_ENABLED', 'SpeechRuleState',
    'SSFMCreate', 'DISPIDSPTSI_ActiveLength', 'ISpeechObjectToken',
    'eLEXTYPE_PRIVATE12', 'SRTEmulated', 'DISPID_SLPLangId',
    ...
    'SPDKL_CurrentConfig', 'SPEVENTENUM', 'SPCS_ENABLED',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SRRRecoContext',
    'SDKLLocalMachine', 'SECHighConfidence', 'SREStreamStart',
    'DISPID_SPRuleNumberOfElements', 'SpeechTokenKeyUI',
    'SpeechPropertyResponseSpeed', 'UINT_PTR', 'SP_VISEME_4',
    'SpWaveFormatEx', 'DISPID_SLPPartOfSpeech', 'SPBO_PAUSE',
    'SGDSActiveWithAutoPause', 'ISpeechGrammarRule',
    'SpeechVisemeFeature', 'SPTEXTSELECTIONINFO',
    'SpeechGrammarState', 'DISPID_SAFType', 'STCLocalServer',
    'DISPID_SRCEFalseRecognition', 'DISPID_SVEBookmark',
    'DISPID_SRSAudioStatus', 'SP_VISEME_6', 'SPEI_MAX_TTS',
    'SPWORDPRONUNCIATIONLIST', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SpeechRecoResultTimes',
    'SAFT16kHz16BitMono', 'SRCS_Enabled', 'SP_VISEME_0',
    'SPBOOKMARKOPTIONS', 'SAFT16kHz16BitStereo',
    'DISPID_SWFEBlockAlign', 'SVP_12', 'DISPID_SPAsItem',
    'SDKLCurrentConfig', 'SpeechStreamSeekPositionType',
    'SECFIgnoreKanaType', 'SpCompressedLexicon', 'SPVOICESTATUS',
    'SPCT_COMMAND', 'SREAudioLevel', 'SBOPause',
    'DISPID_SOTCreateInstance', 'ISpPhrase', 'DISPID_SRGetFormat',
    'SPEI_TTS_BOOKMARK', 'SPPS_NotOverriden', 'DISPID_SWFEFormatTag',
    'DISPID_SPISaveToMemory', 'SLOStatic', 'SPPS_RESERVED4',
    'DISPID_SpeechObjectTokenCategory', 'SpeechVisemeType',
    'SpeechAudioFormatType', 'SVPOver', 'DISPID_SRCreateRecoContext',
    'DISPID_SOTDisplayUI', 'SpeechEmulationCompareFlags',
    'DISPID_SDKSetLongValue', 'SVSFParseSsml', 'DISPID_SPILanguageId',
    'SREStreamEnd', 'SpeechRunState', 'SPEI_SR_BOOKMARK',
    ...
    'IStream', 'SRERecognition', 'DISPID_SPEAudioTimeOffset',
    'SRSInactive', 'SPEI_VISEME', 'SAFTCCITT_ALaw_22kHzStereo',
    'SP_VISEME_13', 'SVP_3', 'DISPID_SOTIsUISupported',
    'SpeechAudioState', '_ISpeechRecoContextEvents', 'SPAUDIOOPTIONS',
    'DISPID_SpeechCustomStream', 'SpeechTokenContext',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SVPause',
